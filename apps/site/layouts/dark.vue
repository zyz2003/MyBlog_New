...
<template>
  <div class="min-h-screen flex flex-col bg-gray-900 text-gray-100">
    <!-- Header -->
    <header class="sticky top-0 z-50 bg-gray-800/80 backdrop-blur-md border-b border-gray-700">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          <!-- Logo -->
          <NuxtLink
            to="/"
            class="text-xl font-bold text-white hover:text-indigo-400 transition-colors"
          >
          ...
          <nav class="hidden md:flex items-center gap-1">
            <NuxtLink
              ...
              :key="link.to"
              :to="link.to"
              class="px-4 py-2 text-sm font-medium text-gray-300 hover:text-indigo-400 rounded-lg hover:bg-gray-700 transition-colors"
              active-class="!text-indigo-400 !bg-indigo-900/30"
            >
              {{ link.label }}
            </NuxtLink>
          </nav>
          ...
          <!-- Mobile menu button -->
          <button class="md:hidden p-2 rounded-lg text-gray-400 hover:bg-gray-700 transition-colors cursor-pointer">
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-4">
            <a href="/rss.xml" class="text-gray-400 hover:text-indigo-400 transition-colors" aria-label="RSS Feed">
