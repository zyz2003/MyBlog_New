...
const statCards = computed(() => [
  { label: 'Total Articles', value: totalCount.value, icon: 'i-heroicons-document-text', color: 'text-blue-600 bg-blue-50' },
  { label: 'Published', value: publishedCount.value, icon: 'i-heroicons-check-circle', color: 'text-green-600 bg-green-50' },
  { label: 'Drafts', value: draftCount.value, icon: 'i-heroicons-pencil-square', color: 'text-yellow-600 bg-yellow-50' },
  { label: 'Total Views', value: totalViews.value, icon: 'i-heroicons-eye', color: 'text-purple-600 bg-purple-50' },
])
...
<template>
  <div>
    ...
    <!-- Recent articles -->
    <div class="card">
      <h2 class="text-lg font-semibold text-gray-900 mb-4">Recent Articles</h2>
      ...
      <table v-else class="w-full">
        <thead>
          <tr class="border-b border-gray-100">
            <th class="text-left py-2 text-sm font-medium text-gray-500">Title</th>
