...
export const posts = sqliteTable('posts', {
  ...
  mathjax: integer('mathjax', { mode: 'boolean' }).default(false),
  katex: integer('katex', { mode: 'boolean' }).default(false),
  toc: integer('toc', { mode: 'boolean' }).default(true),
  ai: text('ai'),
  aside: integer('aside', { mode: 'boolean' }).default(true),
  topImg: text('top_img'),
  keywords: text('keywords'),
  highlightShrink: text('highlight_shrink'),
